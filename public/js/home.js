...
var addRecipeInput = document.getElementById('addRecipeName');
var addRecipeButton = document.getElementById('addRecipeButton');

var addNewRecipe = function addNewRecipe(event) {
    event.preventDefault();

    var recipeName = addRecipeInput.value;

    _axios2.default.put('/api/recipes', { recipeName: recipeName }).then(function (result) {
        var id = result.data.recipe._id;
