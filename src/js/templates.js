...
;pug_debug_line = 2;pug_debug_filename = "views\u002Fshared\u002Feditable-ingredient-row.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = ingredient.amount.value) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E";
...
;pug_debug_line = 3;pug_debug_filename = "views\u002Fshared\u002Feditable-ingredient-row.pug";
pug_html = pug_html + (pug_escape(null == (pug_interp = ingredient.amount.unit) ? "" : pug_interp)) + "\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E";}.call(this,"ingredient" in locals_for_with?locals_for_with.ingredient:typeof ingredient!=="undefined"?ingredient:undefined));} catch (err) {pug.rethrow(err, pug_debug_filename, pug_debug_line);};return pug_html;}function editableJunk(locals) {var pug_html = "", pug_mixins = {}, pug_interp;var pug_debug_filename, pug_debug_line;try {;var locals_for_with = (locals || {});(function (title) {;pug_debug_line = 1;pug_debug_filename = "views\u002Fshared\u002Feditable-junk.pug";
